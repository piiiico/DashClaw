...
This gives the agent 23 governance tools and 6 resources automatically. The 8 core-governance tools are listed below; for the full inventory across optimal files, session continuity, credential hygiene, skill safety, open loops, and learning + retrospection, see [`mcp-server/README.md`](../../mcp-server/README.md).

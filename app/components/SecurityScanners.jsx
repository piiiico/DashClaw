...
const SEVERITY_VARIANT = { critical: 'error', high: 'error', medium: 'warning', low: 'info', info: 'info' };
const RISK_VARIANT = { critical: 'error', high: 'error', medium: 'warning', low: 'info', none: 'success' };
        ...
        {result && result.mode === 'dlp' && (
          <div className="space-y-3 rounded-lg border border-border bg-surface-tertiary px-3 py-3">
            <div className="flex flex-wrap items-center gap-2">
              ...
              {result.categories?.map((c) => <Badge key={c} variant="info" size="xs">{c}</Badge>)}
            </div>

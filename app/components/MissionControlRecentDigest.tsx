...
interface MissionControlRecentDigestProps {
  digest?: any;
}

export default function MissionControlRecentDigest({ digest }: MissionControlRecentDigestProps) {
  return (
        ...
        <div className="rounded-lg border border-border-hover bg-white/[0.02] px-3 py-3">
          ...
          {digest.highlights.length === 0 ? (
            ...
            <div className="space-y-2">
              {digest.highlights.map((item: any) => (

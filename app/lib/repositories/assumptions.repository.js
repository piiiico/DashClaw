export async function listAssumptions(sql, orgId, filters = {}) {
  const {
    validated,
    stale,
    action_id,
...
export async function getAssumption(sql, orgId, assumptionId) {
...
export async function createAssumption(sql, orgId, data) {

...
interface ListPromptRunsFilters {
  templateId?: string;
  versionId?: string;
  limit?: number | string;
}

export async function listPromptRuns(sql: SqlTag, orgId: string, filters: ListPromptRunsFilters = {}): Promise<Record<string, unknown>[]> {

 ...
 */
function formatMatch(ruleId: string, raw: string): string {
 ...
 */
export function scanSkillContent(files: Record<string, unknown>): ScanResult {
 ...
 */
export function hashContent(files: Record<string, unknown>): string {

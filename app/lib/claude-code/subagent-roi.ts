...
export type Recommendation = typeof KEEP | typeof TRIM | typeof DROP;
...
export interface RoiInvocation {
  name?: string;
...
export function computeRoi(invocations: RoiInvocation[] = []): RoiRow[] {
...
export function computeRoiFromRows(rows: AttributionRow[] = []): RoiRow[] {
...
export function recommend({ avgCost, successRate, invocationCount, costPerSuccess }: RecommendInput): Recommendation {

...
function formatLatency(value: any): string {
...
const COUNT_STATS: { label: string; key: string }[] = [
...
interface CapabilityHealthCardsProps {
  health?: any;
}

export default function CapabilityHealthCards({ health }: CapabilityHealthCardsProps) {
  const recentErrors: any[] = Array.isArray(health?.recent_errors) ? health.recent_errors : [];

...
interface CapabilityBasicsForm {
  name: string;
  description: string;
  category: string;
  source_type: string;
...
interface CapabilityBasicsSectionProps {
  form: CapabilityBasicsForm;
  mode: string;
  onChange: (key: string, value: any) => void;
}

export default function CapabilityBasicsSection({ form, mode, onChange }: CapabilityBasicsSectionProps) {
  return (

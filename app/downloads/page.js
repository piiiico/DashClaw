...
function DownloadCard({ name, role, sizeLabel, primaryHref, primaryLabel, secondary, mono = true }) {
  return (
...
function CommandBlock({ children, label }) {
  return (
...
function PluginEntry({ ecosystem, manifest, installCommand, agentId, description }) {
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="rounded-xl border border-border bg-surface-secondary p-5">
              ...
              <p className="text-xs text-text-secondary leading-relaxed mb-3">
                Canonical 125-method surface across core governance, durable finality, scoring, learning, messaging, handoffs, scanning, threads, sessions, execution-studio domains, and x402 spend governance.
              </p>
            ...
            <div className="rounded-xl border border-border bg-surface-secondary p-5">
              ...
              <p className="text-xs text-text-secondary leading-relaxed mb-3">
                Broader Python surface (223 methods) with framework integrations: LangChain callback handler, CrewAI task instrumentation, AutoGen conversation monitoring, and x402 spend governance.
              </p>

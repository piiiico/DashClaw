...
interface PolicyGeneratedAdvancedDetailsProps {
  advancedDetails?: any;
  rawPolicy?: any;
}

export default function PolicyGeneratedAdvancedDetails({ advancedDetails, rawPolicy }: PolicyGeneratedAdvancedDetailsProps) {

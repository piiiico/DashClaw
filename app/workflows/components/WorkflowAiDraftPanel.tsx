...
interface WorkflowAiDraftRequest {
  description: string;
  apiKey: string;
  provider: string;
  model: string;
  preferExistingResources: boolean;
}

interface WorkflowAiDraftPanelProps {
  loading?: boolean;
  error?: string | null;
  onGenerate: (request: WorkflowAiDraftRequest) => void;
}
